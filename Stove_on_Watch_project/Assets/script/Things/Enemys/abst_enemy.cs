...
public abstract class abst_enemy : thing
{
    ...
    private /*readonly*/ List<abst_enemy_action> initial_action_list;
    private List<abst_enemy_action> cur_action_list;
    private List<abst_enemy_action> discarded_action_list;
    private Queue<abst_enemy_action> next_actions;
